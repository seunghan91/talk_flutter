      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _SectionBody(
              text: '이 약관은 Talkk(이하 "회사")가 제공하는 음성 기반 소셜 네트워킹 서비스(이하 "서비스")의 '
                  '이용 조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임 사항 등을 규정함을 목적으로 합니다.',
            ),
            AppSpacing.verticalMd,

            _SectionTitle(title: '제2조 (정의)'),
            _SectionBody(
            ...
            _SectionTitle(title: '제4조 (서비스 이용)'),
            _SectionBody(
            ...
            _SectionTitle(title: '제5조 (회원의 의무)'),
            _SectionBody(
            ...
            _SectionTitle(title: '제6조 (서비스 제한 및 중지)'),
            _SectionBody(
            ...
            _SectionTitle(title: '제7조 (탈퇴 및 자격 상실)'),
            _SectionBody(
